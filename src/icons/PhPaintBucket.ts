...
class PhPaintBucket extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhPaintBucket.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
