...
class PhRectangleDashed extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhRectangleDashed.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
