...
export default class PhGoogleDriveLogo extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhGoogleDriveLogo.weightsMap.get(this.weight)}
    </svg>`;
  }
}
