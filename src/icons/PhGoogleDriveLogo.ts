...
declare global {
  interface HTMLElementTagNameMap {
    "ph-google-drive-logo": IconAttrs;
  }
  namespace JSX {
...
class PhGoogleDriveLogo extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhGoogleDriveLogo.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}

export { PhGoogleDriveLogo };
