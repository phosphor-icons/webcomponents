...
@customElement("ph-pen-nib")
class PhPenNib extends LitElement {
  ...
  render() {
    ...
    >
      ${PhPenNib.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
