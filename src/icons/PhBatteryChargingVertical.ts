...
class PhBatteryChargingVertical extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhBatteryChargingVertical.weightsMap.get(this.weight)}
    </svg>`;
  }
}
