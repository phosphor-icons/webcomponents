...
declare global {
  interface HTMLElementTagNameMap {
    "ph-book-open-user": PhBookOpenUser;
  }
  namespace JSX {
...
class PhBookOpenUser extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhBookOpenUser.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
