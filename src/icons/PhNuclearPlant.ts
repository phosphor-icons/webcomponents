...
declare global {
  interface HTMLElementTagNameMap {
    "ph-nuclear-plant": PhNuclearPlant;
  }
  namespace JSX {
...
class PhNuclearPlant extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhNuclearPlant.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
