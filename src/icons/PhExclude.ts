...
class PhExclude extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhExclude.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
