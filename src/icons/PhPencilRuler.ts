...
class PhPencilRuler extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhPencilRuler.weightsMap.get(this.weight)}
    </svg>`;
  }
}

export { PhPencilRuler };
