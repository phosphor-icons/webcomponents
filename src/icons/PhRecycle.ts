...
class PhRecycle extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhRecycle.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
