...
class PhPassword extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhPassword.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
