...
class PhPhonePause extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhPhonePause.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
