...
@customElement("ph-file-cpp")
class PhFileCpp extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhFileCpp.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
