...
class PhScribble extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhScribble.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
