...
declare global {
  interface HTMLElementTagNameMap {
    "ph-castle-turret": PhCastleTurret;
  }
  namespace JSX {
...
class PhCastleTurret extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhCastleTurret.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}

export { PhCastleTurret };
