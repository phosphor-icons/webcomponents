...
declare global {
  interface HTMLElementTagNameMap {
    "ph-box-arrow-down": PhBoxArrowDown;
  }
  namespace JSX {
...
@customElement("ph-box-arrow-down")
class PhBoxArrowDown extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhBoxArrowDown.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}

export { PhBoxArrowDown };
