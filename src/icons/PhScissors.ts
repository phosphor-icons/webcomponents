...
class PhScissors extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhScissors.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
