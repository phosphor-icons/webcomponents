...
class PhEscalatorUp extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhEscalatorUp.weightsMap.get(this.weight)}
    </svg>`;
  }
}
