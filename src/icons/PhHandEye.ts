...
class PhHandEye extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhHandEye.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
