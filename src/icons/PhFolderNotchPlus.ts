...
declare global {
  interface HTMLElementTagNameMap {
    "ph-folder-notch-plus": PhFolderNotchPlus;
  }
}

@customElement('ph-folder-notch-plus')
class PhFolderNotchPlus extends LitElement {
  static weightsMap = new Map<IconWeight, ReturnType<typeof svg>>([
    ...
    ["regular", svg`<path d="M128,120a8,8,0,0,1,8,8v16h16a8,8,0,0,1,0,16H136v16a8,8,0,0,1-16,0V160H104a8,8,0,0,1,0-16h16V128A8,8,0,0,1,128,120ZM232,88V200a16,16,0,0,1-16,16H40a16,16,0,0,1-16-16V64A16,16,0,0,1,40,48H93.33a16.12,16.12,0,0,1,9.6,3.2L130.67,72H216A16,16,0,0,1,232,88ZM40,96H93.33l21.34-16L93.33,64H40Zm176-8H130.67l-27.74,20.8a16.12,16.12,0,0,1-9.6,3.2H40v88H216Z"/>`],
    ["bold", svg`<path d="M216,68H132L105.33,48a20.12,20.12,0,0,0-12-4H40A20,20,0,0,0,20,64V200a20,20,0,0,0,20,20H216a20,20,0,0,0,20-20V88A20,20,0,0,0,216,68ZM44,68H92l16,12L92,92H44ZM212,196H44V116H93.33a20.12,20.12,0,0,0,12-4L132,92h80Zm-72-72v12h12a12,12,0,0,1,0,24H140v12a12,12,0,0,1-24,0V160H104a12,12,0,0,1,0-24h12V124a12,12,0,0,1,24,0Z"/>`],
    ["fill", svg`<path d="M216,72H130.66L102.92,51.2A16,16,0,0,0,93.34,48H40A16,16,0,0,0,24,64V200a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V88A16,16,0,0,0,216,72ZM40,96V64H93.34l21.33,16L93.33,96Zm112,64H136v16a8,8,0,0,1-16,0V160H104a8,8,0,0,1,0-16h16V128a8,8,0,0,1,16,0v16h16a8,8,0,0,1,0,16Z"/>`],
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhFolderNotchPlus.weightsMap.get(this.weight)}
    </svg>`;
  }
}

export { PhFolderNotchPlus }
