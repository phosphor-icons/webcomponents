...
class PhFolderStar extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhFolderStar.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
