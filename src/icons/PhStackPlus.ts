...
class PhStackPlus extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhStackPlus.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
