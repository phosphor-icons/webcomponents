...
const PhCurrencyJpy = {
  ...
  render: ({ color, size, weight, mirrored }) => html`
    ...
    >
      <slot />
      ${weight === "bold" && svg`<line x1="80" y1="176" x2="176" y2="176" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>
  ...
  <g>
    ...
    <polyline points="200 48 128 136 56 48" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>
      ...
      ${weight === "duotone" && svg`<line x1="80" y1="168" x2="176" y2="168" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
  ...
  <g>
    ...
    <polyline points="200 48 128 136 56 48" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
      ...
      ${weight === "fill" && svg`<path d="M206.19141,53.06592,144.88184,128H176a8,8,0,0,1,0,16H136v16h40a8,8,0,0,1,0,16H136v40a8,8,0,0,1-16,0V176H80a8,8,0,0,1,0-16h40V144H80a8,8,0,0,1,0-16h31.11816L49.80859,53.06592A7.99982,7.99982,0,1,1,62.19141,42.93408L128,123.3667l65.80859-80.43262a7.99982,7.99982,0,1,1,12.38282,10.13184Z"/>`}
      ${weight === "light" && svg`<line x1="80" y1="168" x2="176" y2="168" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>
  ...
  <g>
    ...
    <polyline points="200 48 128 136 56 48" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>
      ...
      ${weight === "thin" && svg`<line x1="80" y1="168" x2="176" y2="168" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>
  ...
  <g>
    ...
    <polyline points="200 48 128 136 56 48" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>
      ...
      ${weight === "regular" && svg`<line x1="80" y1="168" x2="176" y2="168" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
  <line x1="80" y1="136" x2="176" y2="136" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
  <g>
    <line x1="128" y1="136" x2="128" y2="216" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
    <polyline points="200 48 128 136 56 48" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
