...
class PhScroll extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhScroll.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
