...
class PhBluetoothX extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhBluetoothX.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
