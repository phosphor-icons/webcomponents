...
export default class PhReadCvLogo extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhReadCvLogo.weightsMap.get(this.weight)}
    </svg>`;
  }
}
