...
export default class PhCloudMoon extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhCloudMoon.weightsMap.get(this.weight)}
    </svg>`;
  }
}
