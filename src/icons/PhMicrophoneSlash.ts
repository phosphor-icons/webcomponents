...
declare global {
  interface HTMLElementTagNameMap {
    "ph-microphone-slash": PhMicrophoneSlash;
  }
}
...
class PhMicrophoneSlash extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhMicrophoneSlash.weightsMap.get(this.weight)}
    </svg>`;
  }
}
