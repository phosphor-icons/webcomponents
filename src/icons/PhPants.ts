...
export default class PhPants extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhPants.weightsMap.get(this.weight)}
    </svg>`;
  }
}
