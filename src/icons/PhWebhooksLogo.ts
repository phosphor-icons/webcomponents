...
class PhWebhooksLogo extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhWebhooksLogo.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
