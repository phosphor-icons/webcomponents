...
class PhApplePodcastsLogo extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhApplePodcastsLogo.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
