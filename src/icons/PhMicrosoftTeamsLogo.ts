...
declare global {
  interface HTMLElementTagNameMap {
    "ph-microsoft-teams-logo": PhMicrosoftTeamsLogo;
  }
  namespace JSX {
...
class PhMicrosoftTeamsLogo extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhMicrosoftTeamsLogo.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}

export { PhMicrosoftTeamsLogo };
