...
class PhChartPieSlice extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhChartPieSlice.weightsMap.get(this.weight)}
    </svg>`;
  }
}
