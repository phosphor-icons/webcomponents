...
declare global {
  interface HTMLElementTagNameMap {
    "ph-folder-simple-dashed": IconAttrs;
  }
  namespace JSX {
...
class PhFolderSimpleDashed extends LitElement {
  ...
  render() {
    ...
    >
      ${PhFolderSimpleDashed.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
