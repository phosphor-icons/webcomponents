...
class PhScrewdriver extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhScrewdriver.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
