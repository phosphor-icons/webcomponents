...
declare global {
  interface HTMLElementTagNameMap {
    "ph-markdown-logo": PhMarkdownLogo;
  }
  namespace JSX {
...
class PhMarkdownLogo extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhMarkdownLogo.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
