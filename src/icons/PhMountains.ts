...
class PhMountains extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhMountains.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
