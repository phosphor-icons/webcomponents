...
declare global {
  interface HTMLElementTagNameMap {
    "ph-arrows-counter-clockwise": IconAttrs;
  }
  namespace JSX {
...
class PhArrowsCounterClockwise extends LitElement {
  ...
  render() {
    ...
    >
      ${PhArrowsCounterClockwise.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
