...
class PhSelectionPlus extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhSelectionPlus.weightsMap.get(this.weight)}
    </svg>`;
  }
}

export { PhSelectionPlus }
