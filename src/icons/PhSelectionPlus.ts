...
class PhSelectionPlus extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhSelectionPlus.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
