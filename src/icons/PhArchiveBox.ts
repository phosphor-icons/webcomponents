...
declare global {
  interface HTMLElementTagNameMap {
    "ph-archive-box": PhArchiveBox;
  }
}

@customElement('ph-archive-box')
class PhArchiveBox extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhArchiveBox.weightsMap.get(this.weight)}
    </svg>`;
  }
}
