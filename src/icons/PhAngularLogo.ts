...
class PhAngularLogo extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhAngularLogo.weightsMap.get(this.weight)}
    </svg>`;
  }
}
