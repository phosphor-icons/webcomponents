...
declare global {
  interface HTMLElementTagNameMap {
    "ph-umbrella": PhUmbrella;
  }
}

@customElement('ph-umbrella')
class PhUmbrella extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhUmbrella.weightsMap.get(this.weight)}
    </svg>`;
  }
}
