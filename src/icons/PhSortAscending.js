...
const PhSortAscending = {
  ...
  render: ({ color, size, weight, mirrored }) => html`
    ...
    >
      ${weight === "bold" &&
      svg`<polyline points="144 167.994 184 207.994 223.999 168" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>
  ...
  <line x1="48" y1="191.99353" x2="104" y2="191.99353" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>`}
      ${weight === "duotone" &&
      svg`<polyline points="144 167.994 184 207.994 223.999 168" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
  ...
  <line x1="48" y1="191.99353" x2="104" y2="191.99353" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>`}
    ...
    <path d="M104,183.99353H48a8,8,0,0,0,0,16h56a8,8,0,0,0,0-16Z"/>
      ...
      ${weight === "light" &&
      svg`<polyline points="144 167.994 184 207.994 223.999 168" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>
  ...
  <line x1="48" y1="191.99353" x2="104" y2="191.99353" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>`}
      ${weight === "thin" &&
      svg`<polyline points="144 167.994 184 207.994 223.999 168" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>
