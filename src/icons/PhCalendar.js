...
const PhCalendar = {
  ...
  <path d="M88,127.99666h28l-16,20a16,16,0,1,1-11.30681,27.3206" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>
  <polyline points="148 139.997 164 127.997 164 179.997" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>`}
      ${weight === "duotone" && svg`<path d="M40,88H216V48a8,8,0,0,0-8-8H48a8,8,0,0,0-8,8Z" opacity="0.2"/>
  ...
  <path d="M92,127.99666h28l-16,20a16,16,0,1,1-11.30681,27.3206" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>
  <polyline points="144 139.997 160 127.997 160 179.997" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>`}
  ...
  <path d="M92,127.99666h28l-16,20a16,16,0,1,1-11.30681,27.3206" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>
  <polyline points="144 139.997 160 127.997 160 179.997" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>`}
...
define("ph-calendar", PhCalendar);
export default PhCalendar;
