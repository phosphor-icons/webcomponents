...
class PhCursorClick extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhCursorClick.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
