...
@customElement("ph-handbag")
export default class PhHandbag extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhHandbag.weightsMap.get(this.weight)}
    </svg>`;
  }
}
