...
class PhVirtualReality extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhVirtualReality.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
