...
declare global {
  interface HTMLElementTagNameMap {
    "ph-bell-simple-ringing": IconAttrs;
  }
  namespace JSX {
...
class PhBellSimpleRinging extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhBellSimpleRinging.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
