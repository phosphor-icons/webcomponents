...
class PhFileDoc extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhFileDoc.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
