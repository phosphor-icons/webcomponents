...
class PhBoxingGlove extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhBoxingGlove.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}

export { PhBoxingGlove };
