...
declare global {
  interface HTMLElementTagNameMap {
    "ph-caret-circle-up-down": PhCaretCircleUpDown;
  }
  namespace JSX {
...
@customElement("ph-caret-circle-up-down")
class PhCaretCircleUpDown extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhCaretCircleUpDown.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}

export { PhCaretCircleUpDown };
