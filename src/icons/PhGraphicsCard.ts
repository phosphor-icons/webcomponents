...
class PhGraphicsCard extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhGraphicsCard.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}

export { PhGraphicsCard };
