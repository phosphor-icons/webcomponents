...
export default class PhFileHtml extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhFileHtml.weightsMap.get(this.weight)}
    </svg>`;
  }
}
