...
declare global {
  interface HTMLElementTagNameMap {
    "ph-hand-arrow-up": PhHandArrowUp;
  }
  namespace JSX {
...
@customElement("ph-hand-arrow-up")
class PhHandArrowUp extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhHandArrowUp.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}

export { PhHandArrowUp };
