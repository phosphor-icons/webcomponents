...
class PhGitlabLogoSimple extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhGitlabLogoSimple.weightsMap.get(this.weight)}
    </svg>`;
  }
}
