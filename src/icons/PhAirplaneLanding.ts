...
declare global {
  interface HTMLElementTagNameMap {
    "ph-airplane-landing": PhAirplaneLanding;
  }
}

@customElement('ph-airplane-landing')
class PhAirplaneLanding extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhAirplaneLanding.weightsMap.get(this.weight)}
    </svg>`;
  }
}
