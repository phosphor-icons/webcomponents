...
class PhChatsCircle extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhChatsCircle.weightsMap.get(this.weight)}
    </svg>`;
  }
}
