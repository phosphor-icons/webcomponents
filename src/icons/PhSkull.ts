...
class PhSkull extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhSkull.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
