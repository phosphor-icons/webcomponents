...
class PhPencilLine extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhPencilLine.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
