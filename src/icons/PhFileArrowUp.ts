...
@customElement("ph-file-arrow-up")
export default class PhFileArrowUp extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhFileArrowUp.weightsMap.get(this.weight)}
    </svg>`;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "ph-file-arrow-up": PhFileArrowUp;
  }
}
