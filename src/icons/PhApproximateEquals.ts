...
declare global {
  interface HTMLElementTagNameMap {
    "ph-approximate-equals": IconAttrs;
  }
  namespace JSX {
...
class PhApproximateEquals extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhApproximateEquals.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
