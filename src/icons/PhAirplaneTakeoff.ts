...
export default class PhAirplaneTakeoff extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhAirplaneTakeoff.weightsMap.get(this.weight)}
    </svg>`;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "ph-airplane-takeoff": PhAirplaneTakeoff;
  }
}
