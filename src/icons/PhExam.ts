...
@customElement("ph-exam")
class PhExam extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhExam.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
