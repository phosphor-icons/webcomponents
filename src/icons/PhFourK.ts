...
class PhFourK extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhFourK.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
