...
class PhHeadCircuit extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhHeadCircuit.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
