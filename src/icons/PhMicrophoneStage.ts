...
class PhMicrophoneStage extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhMicrophoneStage.weightsMap.get(this.weight)}
    </svg>`;
  }
}

export { PhMicrophoneStage }
