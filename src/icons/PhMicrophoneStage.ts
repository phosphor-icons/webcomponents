...
class PhMicrophoneStage extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhMicrophoneStage.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
