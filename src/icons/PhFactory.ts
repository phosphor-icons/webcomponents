...
export default class PhFactory extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhFactory.weightsMap.get(this.weight)}
    </svg>`;
  }
}
