...
class PhMailbox extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhMailbox.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
