...
class PhPersonArmsSpread extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhPersonArmsSpread.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
