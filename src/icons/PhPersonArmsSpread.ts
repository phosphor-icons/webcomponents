...
class PhPersonArmsSpread extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhPersonArmsSpread.weightsMap.get(this.weight)}
    </svg>`;
  }
}

export { PhPersonArmsSpread }
