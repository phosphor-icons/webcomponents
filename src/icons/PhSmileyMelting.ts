...
declare global {
  interface HTMLElementTagNameMap {
    "ph-smiley-melting": PhSmileyMelting;
  }
  namespace JSX {
...
class PhSmileyMelting extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhSmileyMelting.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}

export { PhSmileyMelting };
