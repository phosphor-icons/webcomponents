...
export default class PhBellSlash extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhBellSlash.weightsMap.get(this.weight)}
    </svg>`;
  }
}
