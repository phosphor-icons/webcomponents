...
class PhPinwheel extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhPinwheel.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
