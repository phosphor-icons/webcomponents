...
class PhChampagne extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhChampagne.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
