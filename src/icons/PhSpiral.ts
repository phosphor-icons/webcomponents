...
export default class PhSpiral extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhSpiral.weightsMap.get(this.weight)}
    </svg>`;
  }
}
