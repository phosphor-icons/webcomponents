...
class PhCrownSimple extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhCrownSimple.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
