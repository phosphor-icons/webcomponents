...
class PhHighHeel extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhHighHeel.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
