...
class PhSubway extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhSubway.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
