...
class PhHeartbeat extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhHeartbeat.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
