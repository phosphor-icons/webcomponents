...
export default class PhParachute extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhParachute.weightsMap.get(this.weight)}
    </svg>`;
  }
}
