...
class PhShieldSlash extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhShieldSlash.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}

export { PhShieldSlash };
