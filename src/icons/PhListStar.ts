...
class PhListStar extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhListStar.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
