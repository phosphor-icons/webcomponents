...
export default class PhBathtub extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhBathtub.weightsMap.get(this.weight)}
    </svg>`;
  }
}
