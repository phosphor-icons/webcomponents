...
const PhArrowsOutLineVertical = {
  ...
  render: ({ color, size, weight, mirrored }) => html`
    ...
    >
      ${weight === "bold" &&
      svg`<line x1="216" y1="128" x2="40" y2="128" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>
  ...
  <polyline points="96 212 128 244 160 212" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>`}
      ${weight === "duotone" &&
      svg`<line x1="216" y1="128" x2="40" y2="128" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
  ...
  <polyline points="160 208 128 240 96 208" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>`}
      ${weight === "thin" &&
      svg`<line x1="216" y1="128" x2="40" y2="128" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>
...
define("ph-arrows-out-line-vertical", PhArrowsOutLineVertical);
export default PhArrowsOutLineVertical;
