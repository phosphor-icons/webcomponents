...
declare global {
  interface HTMLElementTagNameMap {
    "ph-arrows-in-cardinal": PhArrowsInCardinal;
  }
  namespace JSX {
...
class PhArrowsInCardinal extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhArrowsInCardinal.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}

export { PhArrowsInCardinal };
