...
class PhFileCSharp extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhFileCSharp.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
