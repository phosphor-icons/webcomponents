...
export default class PhMicrosoftWordLogo extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhMicrosoftWordLogo.weightsMap.get(this.weight)}
    </svg>`;
  }
}
