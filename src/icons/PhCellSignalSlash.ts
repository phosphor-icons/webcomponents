...
declare global {
  interface HTMLElementTagNameMap {
    "ph-cell-signal-slash": PhCellSignalSlash;
  }
  namespace JSX {
...
class PhCellSignalSlash extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhCellSignalSlash.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}

export { PhCellSignalSlash };
