...
export default class PhLightbulbFilament extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhLightbulbFilament.weightsMap.get(this.weight)}
    </svg>`;
  }
}
