...
class PhPixLogo extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhPixLogo.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
