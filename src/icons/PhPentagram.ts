...
class PhPentagram extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhPentagram.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
