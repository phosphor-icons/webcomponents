...
class PhUserCircleMinus extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhUserCircleMinus.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
