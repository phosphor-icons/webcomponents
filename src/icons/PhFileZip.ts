...
class PhFileZip extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhFileZip.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
