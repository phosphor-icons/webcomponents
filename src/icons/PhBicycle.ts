...
export default class PhBicycle extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhBicycle.weightsMap.get(this.weight)}
    </svg>`;
  }
}
