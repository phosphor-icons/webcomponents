...
class PhGrains extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhGrains.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
