...
declare global {
  interface HTMLElementTagNameMap {
    "ph-cloud-arrow-down": PhCloudArrowDown;
  }
}

@customElement('ph-cloud-arrow-down')
class PhCloudArrowDown extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhCloudArrowDown.weightsMap.get(this.weight)}
    </svg>`;
  }
}
