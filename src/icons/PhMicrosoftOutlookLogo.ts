...
declare global {
  interface HTMLElementTagNameMap {
    "ph-microsoft-outlook-logo": IconAttrs;
  }
  namespace JSX {
...
class PhMicrosoftOutlookLogo extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhMicrosoftOutlookLogo.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
