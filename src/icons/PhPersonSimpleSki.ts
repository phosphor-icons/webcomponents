...
declare global {
  interface HTMLElementTagNameMap {
    "ph-person-simple-ski": PhPersonSimpleSki;
  }
  namespace JSX {
...
class PhPersonSimpleSki extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhPersonSimpleSki.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}

export { PhPersonSimpleSki };
