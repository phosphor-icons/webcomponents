...
class PhGoogleChromeLogo extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhGoogleChromeLogo.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
