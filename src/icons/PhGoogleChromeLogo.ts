...
declare global {
  interface HTMLElementTagNameMap {
    "ph-google-chrome-logo": PhGoogleChromeLogo;
  }
}

@customElement('ph-google-chrome-logo')
class PhGoogleChromeLogo extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhGoogleChromeLogo.weightsMap.get(this.weight)}
    </svg>`;
  }
}

export { PhGoogleChromeLogo }
