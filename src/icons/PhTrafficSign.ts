...
class PhTrafficSign extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhTrafficSign.weightsMap.get(this.weight)}
    </svg>`;
  }
}

export { PhTrafficSign }
