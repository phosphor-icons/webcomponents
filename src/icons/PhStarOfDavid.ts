...
declare global {
  interface HTMLElementTagNameMap {
    "ph-star-of-david": PhStarOfDavid;
  }
}
...
class PhStarOfDavid extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhStarOfDavid.weightsMap.get(this.weight)}
    </svg>`;
  }
}
