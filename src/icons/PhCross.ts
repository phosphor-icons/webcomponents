...
class PhCross extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhCross.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
