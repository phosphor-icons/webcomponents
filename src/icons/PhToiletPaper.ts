...
class PhToiletPaper extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhToiletPaper.weightsMap.get(this.weight)}
    </svg>`;
  }
}

export { PhToiletPaper };
