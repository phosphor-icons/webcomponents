...
class PhGitDiff extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhGitDiff.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
