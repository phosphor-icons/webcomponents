...
class PhSneaker extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhSneaker.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
