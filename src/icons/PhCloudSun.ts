...
class PhCloudSun extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhCloudSun.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
