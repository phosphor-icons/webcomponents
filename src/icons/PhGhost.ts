...
@customElement('ph-ghost')
class PhGhost extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhGhost.weightsMap.get(this.weight)}
    </svg>`;
  }
}
