...
declare global {
  interface HTMLElementTagNameMap {
    "ph-speaker-simple-low": IconAttrs;
  }
  namespace JSX {
...
class PhSpeakerSimpleLow extends LitElement {
  static weightsMap = new Map<IconWeight, ReturnType<typeof svg>>([
    ...
    [
      "regular",
      svg`<path d="M163.51,24.81a8,8,0,0,0-8.42.88L85.25,80H40A16,16,0,0,0,24,96v64a16,16,0,0,0,16,16H85.25l69.84,54.31A8,8,0,0,0,168,224V32A8,8,0,0,0,163.51,24.81ZM152,207.64,92.91,161.69A7.94,7.94,0,0,0,88,160H40V96H88a7.94,7.94,0,0,0,4.91-1.69L152,48.36ZM208,104v48a8,8,0,0,1-16,0V104a8,8,0,0,1,16,0Z"/>`,
    ],
    [
      "bold",
    ...
    [
      "fill",
      svg`<path d="M168,32V224a8,8,0,0,1-12.91,6.31L85.25,176H40a16,16,0,0,1-16-16V96A16,16,0,0,1,40,80H85.25l69.84-54.31A8,8,0,0,1,168,32Zm32,64a8,8,0,0,0-8,8v48a8,8,0,0,0,16,0V104A8,8,0,0,0,200,96Z"/>`,
    ],
    [
      "duotone",
  ...
  render() {
    ...
    >
      ${PhSpeakerSimpleLow.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
