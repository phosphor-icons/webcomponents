...
class PhFunnelX extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhFunnelX.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
