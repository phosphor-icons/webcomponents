...
const PhArrowLineLeft = {
  ...
  render: ({ color, size, weight, mirrored }) => html`
    ...
    >
      <slot />
      ${weight === "bold" && svg`<line x1="232.00373" y1="128" x2="80.00373" y2="128" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>
  ...
  <line x1="40.00373" y1="48" x2="40.00373" y2="208" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>`}
      ${weight === "duotone" && svg`<line x1="232.00373" y1="128" x2="72.00373" y2="128" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
  ...
  <line x1="40.00373" y1="48" x2="40.00373" y2="208" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>`}
      ${weight === "fill" && svg`<g>
    ...
    <path d="M40.00391,40a7.99977,7.99977,0,0,0-8,8V208a8,8,0,0,0,16,0V48A8.00009,8.00009,0,0,0,40.00391,40Z"/>
      ...
      ${weight === "light" && svg`<line x1="232.00373" y1="128" x2="72.00373" y2="128" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>
  ...
  <line x1="40.00373" y1="48" x2="40.00373" y2="208" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>`}
      ${weight === "thin" && svg`<line x1="232.00373" y1="128" x2="72.00373" y2="128" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>
  ...
  <line x1="40.00373" y1="48" x2="40.00373" y2="208" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>`}
      ${weight === "regular" && svg`<line x1="232.00373" y1="128" x2="72.00373" y2="128" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
  <polyline points="144.004 56 72.004 128 144.004 200" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
  <line x1="40.00373" y1="48" x2="40.00373" y2="208" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>`}
    </svg>
  `,
...
define("ph-arrow-line-left", PhArrowLineLeft);
export default PhArrowLineLeft;
