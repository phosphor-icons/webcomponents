...
class PhEngine extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhEngine.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
