...
class PhEyedropper extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhEyedropper.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
