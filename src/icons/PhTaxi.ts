...
export default class PhTaxi extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhTaxi.weightsMap.get(this.weight)}
    </svg>`;
  }
}
