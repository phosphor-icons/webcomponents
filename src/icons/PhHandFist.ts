...
class PhHandFist extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhHandFist.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
