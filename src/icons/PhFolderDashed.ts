...
class PhFolderDashed extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhFolderDashed.weightsMap.get(this.weight)}
    </svg>`;
  }
}
