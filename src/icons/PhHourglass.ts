...
@customElement("ph-hourglass")
class PhHourglass extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhHourglass.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
