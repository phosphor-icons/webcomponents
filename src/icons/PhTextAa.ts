...
class PhTextAa extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhTextAa.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
