...
class PhWindowsLogo extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhWindowsLogo.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}

export { PhWindowsLogo };
