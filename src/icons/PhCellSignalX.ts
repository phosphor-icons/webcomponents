...
class PhCellSignalX extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhCellSignalX.weightsMap.get(this.weight)}
    </svg>`;
  }
}
