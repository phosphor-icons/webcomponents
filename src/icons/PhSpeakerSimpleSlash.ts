...
declare global {
  interface HTMLElementTagNameMap {
    "ph-speaker-simple-slash": PhSpeakerSimpleSlash;
  }
  namespace JSX {
...
class PhSpeakerSimpleSlash extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhSpeakerSimpleSlash.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}

export { PhSpeakerSimpleSlash };
