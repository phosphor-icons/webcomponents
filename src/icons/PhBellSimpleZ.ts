...
class PhBellSimpleZ extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhBellSimpleZ.weightsMap.get(this.weight)}
    </svg>`;
  }
}

export { PhBellSimpleZ }
