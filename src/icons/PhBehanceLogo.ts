...
class PhBehanceLogo extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhBehanceLogo.weightsMap.get(this.weight)}
    </svg>`;
  }
}
