...
@customElement("ph-globe-simple")
class PhGlobeSimple extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhGlobeSimple.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}

export { PhGlobeSimple };
