...
declare global {
  interface HTMLElementTagNameMap {
    "ph-amazon-logo": PhAmazonLogo;
  }
}

@customElement('ph-amazon-logo')
class PhAmazonLogo extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhAmazonLogo.weightsMap.get(this.weight)}
    </svg>`;
  }
}
