...
class PhShuffle extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhShuffle.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
