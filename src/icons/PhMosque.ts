...
class PhMosque extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhMosque.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
