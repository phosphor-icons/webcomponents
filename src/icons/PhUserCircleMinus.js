...
const PhUserCircleMinus = {
  ...
  <path d="M218.5374,96A95.90174,95.90174,0,1,1,143.13974,33.187" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>`}
  ...
  <path d="M218.5374,96A95.90174,95.90174,0,1,1,143.13974,33.187" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>`}
  ...
  <path d="M218.5374,96A95.90174,95.90174,0,1,1,143.13974,33.187" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>`}
...
define("ph-user-circle-minus", PhUserCircleMinus);
export default PhUserCircleMinus;
