...
class PhUserGear extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhUserGear.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
