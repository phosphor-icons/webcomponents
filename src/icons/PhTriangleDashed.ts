...
class PhTriangleDashed extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhTriangleDashed.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
