...
class PhMegaphone extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhMegaphone.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
