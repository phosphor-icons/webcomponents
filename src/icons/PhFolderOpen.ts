...
class PhFolderOpen extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhFolderOpen.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
