...
class PhSynagogue extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhSynagogue.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
