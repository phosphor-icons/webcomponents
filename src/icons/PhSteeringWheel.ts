...
export default class PhSteeringWheel extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhSteeringWheel.weightsMap.get(this.weight)}
    </svg>`;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "ph-steering-wheel": PhSteeringWheel;
  }
}
