...
class PhHeartBreak extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhHeartBreak.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
