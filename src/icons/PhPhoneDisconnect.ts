...
class PhPhoneDisconnect extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhPhoneDisconnect.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
