...
class PhSeatbelt extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhSeatbelt.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
