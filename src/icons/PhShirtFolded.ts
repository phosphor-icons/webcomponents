...
class PhShirtFolded extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhShirtFolded.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
