...
class PhTrainRegional extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhTrainRegional.weightsMap.get(this.weight)}
    </svg>`;
  }
}
