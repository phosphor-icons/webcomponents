...
class PhUsersFour extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhUsersFour.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
