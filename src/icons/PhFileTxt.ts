...
class PhFileTxt extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhFileTxt.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
