...
class PhPolygon extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhPolygon.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
