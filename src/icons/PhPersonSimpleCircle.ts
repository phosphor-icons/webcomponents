...
declare global {
  interface HTMLElementTagNameMap {
    "ph-person-simple-circle": PhPersonSimpleCircle;
  }
  namespace JSX {
...
@customElement("ph-person-simple-circle")
class PhPersonSimpleCircle extends LitElement {
  static weightsMap = new Map<IconWeight, ReturnType<typeof svg>>([
    ...
    [
      "fill",
      svg`<path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,40a16,16,0,1,1-16,16A16,16,0,0,1,128,64Zm48,56H136v13.58l30.66,46a8,8,0,0,1-13.32,8.88l-25.34-38-25.34,38a8,8,0,1,1-13.32-8.88l30.66-46V120H80a8,8,0,0,1,0-16h96a8,8,0,0,1,0,16Z"/>`,
    ],
    [
      "duotone",
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhPersonSimpleCircle.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}

export { PhPersonSimpleCircle };
