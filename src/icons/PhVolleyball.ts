...
@customElement("ph-volleyball")
class PhVolleyball extends LitElement {
  ...
  render() {
    ...
    >
      ${PhVolleyball.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
