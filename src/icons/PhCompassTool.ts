...
class PhCompassTool extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhCompassTool.weightsMap.get(this.weight)}
    </svg>`;
  }
}
