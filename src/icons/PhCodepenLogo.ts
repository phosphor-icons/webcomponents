...
class PhCodepenLogo extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhCodepenLogo.weightsMap.get(this.weight)}
    </svg>`;
  }
}
