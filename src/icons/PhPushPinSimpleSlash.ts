...
export default class PhPushPinSimpleSlash extends LitElement {
  static weightsMap = new Map<IconWeight, ReturnType<typeof svg>>([
    ...
    [
      "fill",
      svg`<path d="M213.38,221.92a8,8,0,0,1-11.3-.54L168.1,184H136v56a8,8,0,0,1-16,0V184H40a8,8,0,0,1,0-16h9.29L66.24,72,42.08,45.38A8,8,0,1,1,53.92,34.62l160,176A8,8,0,0,1,213.38,221.92ZM190.5,161.07a8,8,0,0,0,13.79-6.77L185.54,48H192a8,8,0,0,0,0-16H91.25a8,8,0,0,0-5.92,13.38Z"/>`,
    ],
    [
      "duotone",
