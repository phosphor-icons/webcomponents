...
class PhUserSwitch extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhUserSwitch.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
