...
class PhBatteryWarning extends LitElement {
  static weightsMap = new Map<IconWeight, ReturnType<typeof svg>>([
    ...
    [
      "light",
      svg`<path d="M200,58H32A22,22,0,0,0,10,80v96a22,22,0,0,0,22,22H200a22,22,0,0,0,22-22V80A22,22,0,0,0,200,58Zm10,118a10,10,0,0,1-10,10H32a10,10,0,0,1-10-10V80A10,10,0,0,1,32,70H200a10,10,0,0,1,10,10Zm44-80v64a6,6,0,0,1-12,0V96a6,6,0,0,1,12,0ZM110,124V96a6,6,0,0,1,12,0v28a6,6,0,0,1-12,0Zm16,32a10,10,0,1,1-10-10A10,10,0,0,1,126,156Z"/>`,
    ],
    [
      "regular",
    ...
    [
      "fill",
      svg`<path d="M200,56H32A24,24,0,0,0,8,80v96a24,24,0,0,0,24,24H200a24,24,0,0,0,24-24V80A24,24,0,0,0,200,56ZM108,88a8,8,0,0,1,16,0v40a8,8,0,0,1-16,0Zm8,88a12,12,0,1,1,12-12A12,12,0,0,1,116,176ZM256,96v64a8,8,0,0,1-16,0V96a8,8,0,0,1,16,0Z"/>`,
    ],
    [
      "duotone",
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhBatteryWarning.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
