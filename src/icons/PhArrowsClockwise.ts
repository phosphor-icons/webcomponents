...
class PhArrowsClockwise extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhArrowsClockwise.weightsMap.get(this.weight)}
    </svg>`;
  }
}
