...
@customElement("ph-lastfm-logo")
class PhLastfmLogo extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhLastfmLogo.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
