...
declare global {
  interface HTMLElementTagNameMap {
    "ph-google-photos-logo": PhGooglePhotosLogo;
  }
}

@customElement('ph-google-photos-logo')
class PhGooglePhotosLogo extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhGooglePhotosLogo.weightsMap.get(this.weight)}
    </svg>`;
  }
}

export { PhGooglePhotosLogo }
