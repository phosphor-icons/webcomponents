...
class PhBugBeetle extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhBugBeetle.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
