...
declare global {
  interface HTMLElementTagNameMap {
    "ph-trademark": PhTrademark;
  }
}

@customElement('ph-trademark')
class PhTrademark extends LitElement {
  static weightsMap = new Map<IconWeight, ReturnType<typeof svg>>([
    ...
    ["fill", svg`<path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm-24,88H96v40a8,8,0,0,1-16,0V112H72a8,8,0,0,1,0-16h32a8,8,0,0,1,0,16Zm88,40a8,8,0,0,1-16,0V125.29l-14,16a8,8,0,0,1-12,0l-14-16V152a8,8,0,0,1-16,0V104a8,8,0,0,1,14-5.27l22,25.12,22-25.12A8,8,0,0,1,192,104Z"/>`],
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhTrademark.weightsMap.get(this.weight)}
    </svg>`;
  }
}
