...
declare global {
  interface HTMLElementTagNameMap {
    "ph-person-simple-snowboard": PhPersonSimpleSnowboard;
  }
  namespace JSX {
...
class PhPersonSimpleSnowboard extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhPersonSimpleSnowboard.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}

export { PhPersonSimpleSnowboard };
