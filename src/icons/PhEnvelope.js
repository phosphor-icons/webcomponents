...
const PhEnvelope = {
  ...
  render: ({ color, size, weight, mirrored }) => html`
    ...
    >
      <slot></slot>
      ${weight === "bold" &&
      svg`<polyline points="224 56 128 144 32 56" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>
  ...
  <line x1="221.53418" y1="197.73926" x2="145.45424" y2="127.99964" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>`}
      ${weight === "duotone" &&
      svg`<polygon points="224.006 56 128.006 144 32.006 56 224.006 56" opacity="0.2"/>
  ...
  <line x1="221.53418" y1="197.73926" x2="145.45424" y2="127.99964" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>`}
      ${weight === "thin" &&
      svg`<polyline points="224 56 128 144 32 56" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>
  ...
  <line x1="221.53418" y1="197.73926" x2="145.45424" y2="127.99964" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>`}
      ${weight === "regular" &&
      svg`<polyline points="224 56 128 144 32 56" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
  <path d="M32,56H224a0,0,0,0,1,0,0V192a8,8,0,0,1-8,8H40a8,8,0,0,1-8-8V56A0,0,0,0,1,32,56Z" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
  <line x1="110.54541" y1="128.00013" x2="34.4668" y2="197.73926" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
  <line x1="221.53418" y1="197.73926" x2="145.45424" y2="127.99964" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>`}
    </svg>
