...
class PhTranslate extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhTranslate.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
