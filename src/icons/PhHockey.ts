...
class PhHockey extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhHockey.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
