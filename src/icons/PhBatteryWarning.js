...
const PhBatteryWarning = {
  ...
  render: ({ color, size, weight, mirrored }) => html`
    ...
    >
      <slot></slot>
      ${weight === "bold" &&
      svg`<rect x="46" y="38.00452" width="144" height="180" rx="16" transform="translate(246.00452 10.00452) rotate(90)" stroke-width="24" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
  ...
  <circle cx="116" cy="164" r="10"/>`}
      ${weight === "thin" &&
      svg`<line x1="116" y1="88" x2="116" y2="128" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>
  ...
  <circle cx="116" cy="164" r="8"/>`}
      ${weight === "regular" &&
      svg`<line x1="116" y1="88" x2="116" y2="128" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
  <line x1="240" y1="96" x2="240" y2="160" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
  <rect x="44" y="36" width="144" height="184" rx="16" transform="translate(244 12) rotate(90)" stroke-width="16" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
  <circle cx="116" cy="164" r="12"/>`}
    </svg>
