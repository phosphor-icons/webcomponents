...
class PhPoliceCar extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhPoliceCar.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
