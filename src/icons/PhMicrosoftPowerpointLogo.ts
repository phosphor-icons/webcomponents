...
declare global {
  interface HTMLElementTagNameMap {
    "ph-microsoft-powerpoint-logo": IconAttrs;
  }
  namespace JSX {
...
class PhMicrosoftPowerpointLogo extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhMicrosoftPowerpointLogo.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
