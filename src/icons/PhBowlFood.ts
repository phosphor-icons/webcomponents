...
class PhBowlFood extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhBowlFood.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
