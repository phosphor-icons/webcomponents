...
class PhFileIni extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhFileIni.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
