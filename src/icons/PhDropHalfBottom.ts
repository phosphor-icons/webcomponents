...
class PhDropHalfBottom extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhDropHalfBottom.weightsMap.get(this.weight)}
    </svg>`;
  }
}

export { PhDropHalfBottom }
