...
class PhDesktopTower extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhDesktopTower.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
