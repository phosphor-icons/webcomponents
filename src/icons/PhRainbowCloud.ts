...
export default class PhRainbowCloud extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhRainbowCloud.weightsMap.get(this.weight)}
    </svg>`;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "ph-rainbow-cloud": PhRainbowCloud;
  }
}
