...
declare global {
  interface HTMLElementTagNameMap {
    "ph-bug-droid": PhBugDroid;
  }
}

@customElement('ph-bug-droid')
class PhBugDroid extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhBugDroid.weightsMap.get(this.weight)}
    </svg>`;
  }
}
