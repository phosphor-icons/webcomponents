...
declare global {
  interface HTMLElementTagNameMap {
    "ph-selection-background": PhSelectionBackground;
  }
  namespace JSX {
...
class PhSelectionBackground extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhSelectionBackground.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}

export { PhSelectionBackground };
