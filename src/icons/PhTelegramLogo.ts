...
class PhTelegramLogo extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhTelegramLogo.weightsMap.get(this.weight)}
    </svg>`;
  }
}

export { PhTelegramLogo }
