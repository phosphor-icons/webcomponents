...
declare global {
  interface HTMLElementTagNameMap {
    "ph-lock-laminated-open": PhLockLaminatedOpen;
  }
}

@customElement('ph-lock-laminated-open')
class PhLockLaminatedOpen extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhLockLaminatedOpen.weightsMap.get(this.weight)}
    </svg>`;
  }
}

export { PhLockLaminatedOpen }
