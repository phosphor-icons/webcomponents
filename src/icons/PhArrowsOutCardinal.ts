...
class PhArrowsOutCardinal extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhArrowsOutCardinal.weightsMap.get(this.weight)}
    </svg>`;
  }
}

export { PhArrowsOutCardinal }
