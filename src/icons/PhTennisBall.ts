...
export default class PhTennisBall extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhTennisBall.weightsMap.get(this.weight)}
    </svg>`;
  }
}
