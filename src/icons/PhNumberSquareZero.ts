...
class PhNumberSquareZero extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhNumberSquareZero.weightsMap.get(this.weight)}
    </svg>`;
  }
}
