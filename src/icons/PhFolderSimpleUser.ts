...
class PhFolderSimpleUser extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhFolderSimpleUser.weightsMap.get(this.weight)}
    </svg>`;
  }
}
