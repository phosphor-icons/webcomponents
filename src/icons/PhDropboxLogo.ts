...
class PhDropboxLogo extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhDropboxLogo.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
