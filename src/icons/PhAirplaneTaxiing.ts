...
declare global {
  interface HTMLElementTagNameMap {
    "ph-airplane-taxiing": PhAirplaneTaxiing;
  }
  namespace JSX {
...
class PhAirplaneTaxiing extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhAirplaneTaxiing.weightsMap.get(this.weight)}
    </svg>`;
  }
}
