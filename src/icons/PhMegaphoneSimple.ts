...
declare global {
  interface HTMLElementTagNameMap {
    "ph-megaphone-simple": PhMegaphoneSimple;
  }
  namespace JSX {
...
class PhMegaphoneSimple extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhMegaphoneSimple.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}

export { PhMegaphoneSimple };
