...
class PhCheese extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhCheese.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
