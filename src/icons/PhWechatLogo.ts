...
class PhWechatLogo extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhWechatLogo.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
