...
declare global {
  interface HTMLElementTagNameMap {
    "ph-person-simple-throw": PhPersonSimpleThrow;
  }
  namespace JSX {
...
class PhPersonSimpleThrow extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhPersonSimpleThrow.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
