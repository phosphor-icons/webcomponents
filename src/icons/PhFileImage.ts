...
class PhFileImage extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhFileImage.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
