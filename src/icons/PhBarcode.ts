...
declare global {
  interface HTMLElementTagNameMap {
    "ph-barcode": PhBarcode;
  }
}

@customElement('ph-barcode')
class PhBarcode extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhBarcode.weightsMap.get(this.weight)}
    </svg>`;
  }
}
