...
class PhPencilCircle extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhPencilCircle.weightsMap.get(this.weight)}
    </svg>`;
  }
}

export { PhPencilCircle }
