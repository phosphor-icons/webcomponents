...
class PhEject extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhEject.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
