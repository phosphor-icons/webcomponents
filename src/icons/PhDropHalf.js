...
const PhDropHalf = {
  ...
  <line x1="127.99999" y1="147.99999" x2="186.53165" y2="206.53165" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>`}
      ${weight === "duotone" && svg`<path d="M128,232a80,80,0,0,0,80-80c0-72-80-128-80-128Z" opacity="0.2"/>
  ...
  <line x1="128" y1="232" x2="128" y2="24" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>`}
      ${weight === "fill" && svg`<path d="M208,152c0-72-80-128-80-128S48,80,48,152a80,80,0,0,0,160,0Z" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
