...
const PhClockClockwise = {
  ...
  <polyline points="184.167 99.716 224.167 99.716 224.167 59.716" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>
  ...
  <polyline points="184.167 99.716 224.167 99.716 224.167 59.716" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
  ...
  <polyline points="184.167 99.716 224.167 99.716 224.167 59.716" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>
  ...
  <polyline points="184.167 99.716 224.167 99.716 224.167 59.716" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>
...
define("ph-clock-clockwise", PhClockClockwise);
