...
class PhBoundingBox extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhBoundingBox.weightsMap.get(this.weight)}
    </svg>`;
  }
}
