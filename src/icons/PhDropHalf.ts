...
declare global {
  interface HTMLElementTagNameMap {
    "ph-drop-half": PhDropHalf;
  }
}

@customElement('ph-drop-half')
class PhDropHalf extends LitElement {
  static weightsMap = new Map<IconWeight, ReturnType<typeof svg>>([
    ...
    ["fill", svg`<path d="M174,47.75a254.19,254.19,0,0,0-41.45-38.3,8,8,0,0,0-9.18,0A254.19,254.19,0,0,0,82,47.75C54.51,79.32,40,112.6,40,144a88,88,0,0,0,176,0C216,112.6,201.49,79.32,174,47.75ZM56,144c0-57.23,55.47-105,72-118V216A72.08,72.08,0,0,1,56,144Z"/>`],
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhDropHalf.weightsMap.get(this.weight)}
    </svg>`;
  }
}
