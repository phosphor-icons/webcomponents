...
declare global {
  interface HTMLElementTagNameMap {
    "ph-diamonds-four": PhDiamondsFour;
  }
  namespace JSX {
...
class PhDiamondsFour extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhDiamondsFour.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
