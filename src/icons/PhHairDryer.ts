...
class PhHairDryer extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhHairDryer.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
