...
class PhPinterestLogo extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhPinterestLogo.weightsMap.get(this.weight)}
    </svg>`;
  }
}

export { PhPinterestLogo }
