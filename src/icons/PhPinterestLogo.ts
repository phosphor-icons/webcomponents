...
class PhPinterestLogo extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhPinterestLogo.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
