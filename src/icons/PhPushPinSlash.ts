...
class PhPushPinSlash extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhPushPinSlash.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}

export { PhPushPinSlash };
