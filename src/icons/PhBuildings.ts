...
class PhBuildings extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhBuildings.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
