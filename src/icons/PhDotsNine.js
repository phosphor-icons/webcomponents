...
const PhDotsNine = {
  ...
  render: ({ color, size, weight, mirrored }) => html`
    ...
    >
      <slot />
      ${weight === "bold" && svg`<circle cx="60" cy="60" r="16"/>
  ...
  <circle cx="196" cy="196" r="16"/>`}
      ${weight === "duotone" && svg`<circle cx="60" cy="60" r="12"/>
  ...
  <circle cx="196" cy="196" r="10"/>`}
      ${weight === "thin" && svg`<circle cx="60" cy="60" r="8"/>
  ...
  <circle cx="196" cy="196" r="8"/>`}
      ${weight === "regular" && svg`<circle cx="60" cy="60" r="12"/>
  <circle cx="128" cy="60" r="12"/>
  <circle cx="196" cy="60" r="12"/>
  <circle cx="60" cy="128" r="12"/>
  <circle cx="128" cy="128" r="12"/>
