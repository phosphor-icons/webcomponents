...
class PhBezierCurve extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhBezierCurve.weightsMap.get(this.weight)}
    </svg>`;
  }
}
