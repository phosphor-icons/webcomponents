...
declare global {
  interface HTMLElementTagNameMap {
    "ph-hourglass-medium": PhHourglassMedium;
  }
}
...
class PhHourglassMedium extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhHourglassMedium.weightsMap.get(this.weight)}
    </svg>`;
  }
}
