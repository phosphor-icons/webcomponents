...
class PhPaypalLogo extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhPaypalLogo.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
