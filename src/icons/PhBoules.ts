...
@customElement("ph-boules")
class PhBoules extends LitElement {
  ...
  render() {
    ...
    >
      ${PhBoules.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
