...
const PhFileSearch = {
  ...
  <circle cx="123.9941" cy="148" r="24" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>
  <line x1="140.96467" y1="164.97053" x2="159.79313" y2="183.79899" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>`}
      ${weight === "duotone" &&
  ...
  <line x1="143.79313" y1="167.79899" x2="159.79313" y2="183.79899" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
  <circle cx="123.99414" cy="148" r="28" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>`}
      ${weight === "fill" &&
  ...
  <line x1="143.79313" y1="167.79899" x2="159.79313" y2="183.79899" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>
  <circle cx="123.99414" cy="148" r="28" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>`}
      ${weight === "thin" &&
  ...
  <line x1="143.79313" y1="167.79899" x2="159.79313" y2="183.79899" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>
  <circle cx="123.99414" cy="148" r="28" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>`}
      ${weight === "regular" &&
...
define("ph-file-search", PhFileSearch);
export default PhFileSearch;
