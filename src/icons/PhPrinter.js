...
const PhPrinter = {
  ...
  render: ({ color, size, weight, mirrored }) => html`
    ...
    >
      ${weight === "bold" &&
      svg`<rect x="63.99414" y="40" width="128" height="40" stroke-width="24" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
  ...
  <circle cx="188" cy="116" r="16"/>`}
      ${weight === "duotone" &&
      svg`<path d="M210.66083,80H45.32751c-9.57293,0-17.33337,7.16357-17.33337,16v80h36V152h128v24h36V96C227.99414,87.16357,220.23376,80,210.66083,80Z" opacity="0.2"/>
  ...
  <circle cx="188" cy="116" r="10"/>`}
      ${weight === "thin" &&
      svg`<polyline points="63.994 80 63.994 40 191.994 40 191.994 80" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>
  ...
  <circle cx="188" cy="116" r="8"/>`}
      ${weight === "regular" &&
      svg`<polyline points="63.994 80 63.994 40 191.994 40 191.994 80" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
  <rect x="63.99414" y="152" width="128" height="68" stroke-width="16" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
  <path d="M63.99414,176h-36V96c0-8.83656,7.7604-16,17.33333-16H210.66081c9.57293,0,17.33333,7.16344,17.33333,16v80h-36" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
  <circle cx="188" cy="116" r="12"/>`}
    </svg>
