...
class PhHandPalm extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhHandPalm.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
