...
class PhFileVue extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhFileVue.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
