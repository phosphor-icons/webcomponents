...
declare global {
  interface HTMLElementTagNameMap {
    "ph-traffic-signal": PhTrafficSignal;
  }
  namespace JSX {
...
class PhTrafficSignal extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhTrafficSignal.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
