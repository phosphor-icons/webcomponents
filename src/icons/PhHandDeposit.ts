...
class PhHandDeposit extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhHandDeposit.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}

export { PhHandDeposit };
