...
const PhSignIn = {
  ...
  render: ({ color, size, weight, mirrored }) => html`
    ...
    >
      <slot></slot>
      ${weight === "bold" &&
      svg`<polyline points="94 170 136 128 94 86" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>
  ...
  <path d="M120,40h72a8,8,0,0,1,8,8V208a8,8,0,0,1-8,8H120" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>`}
      ${weight === "duotone" &&
      svg`<polyline points="94 170 136 128 94 86" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
  ...
  <path d="M120,40h72a8,8,0,0,1,8,8V208a8,8,0,0,1-8,8H120" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>`}
    ...
    <path d="M192,32H120a8,8,0,0,0,0,16h72V208H120a8,8,0,0,0,0,16h72a16.01833,16.01833,0,0,0,16-16V48A16.01833,16.01833,0,0,0,192,32Z"/>
      ...
      ${weight === "light" &&
      svg`<polyline points="94 170 136 128 94 86" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>
  ...
  <path d="M120,40h72a8,8,0,0,1,8,8V208a8,8,0,0,1-8,8H120" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>`}
      ${weight === "thin" &&
      svg`<polyline points="94 170 136 128 94 86" fill="none" stroke="${color}" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>
