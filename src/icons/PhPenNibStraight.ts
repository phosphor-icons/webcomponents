...
class PhPenNibStraight extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhPenNibStraight.weightsMap.get(this.weight)}
    </svg>`;
  }
}
