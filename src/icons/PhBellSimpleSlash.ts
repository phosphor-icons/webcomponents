...
class PhBellSimpleSlash extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhBellSimpleSlash.weightsMap.get(this.weight)}
    </svg>`;
  }
}

export { PhBellSimpleSlash }
