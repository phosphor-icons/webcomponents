...
class PhShoppingCart extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhShoppingCart.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
