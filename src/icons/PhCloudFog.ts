...
class PhCloudFog extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhCloudFog.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
