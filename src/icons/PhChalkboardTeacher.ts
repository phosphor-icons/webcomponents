...
declare global {
  interface HTMLElementTagNameMap {
    "ph-chalkboard-teacher": PhChalkboardTeacher;
  }
}
...
class PhChalkboardTeacher extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhChalkboardTeacher.weightsMap.get(this.weight)}
    </svg>`;
  }
}
