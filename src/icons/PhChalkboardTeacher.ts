...
declare global {
  interface HTMLElementTagNameMap {
    "ph-chalkboard-teacher": IconAttrs;
  }
  namespace JSX {
...
class PhChalkboardTeacher extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhChalkboardTeacher.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
