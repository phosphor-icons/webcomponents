...
class PhFolderNotchOpen extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhFolderNotchOpen.weightsMap.get(this.weight)}
    </svg>`;
  }
}

export { PhFolderNotchOpen }
