...
class PhChartPolar extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhChartPolar.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
