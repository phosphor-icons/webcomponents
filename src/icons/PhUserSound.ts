...
class PhUserSound extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhUserSound.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
}
