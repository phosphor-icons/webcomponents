...
class PhSpeedometer extends LitElement {
  ...
  render() {
    ...
    >
      <slot></slot>
      ${PhSpeedometer.weightsMap.get(this.weight ?? "regular")}
    </svg>`;
  }
