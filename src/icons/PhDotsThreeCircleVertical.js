...
const PhDotsThreeCircleVertical = {
  ...
  <circle cx="128" cy="176" r="12"/>`}
      ${weight === "fill" &&
      svg`<path d="M232,128A104,104,0,1,0,128,232,104.12041,104.12041,0,0,0,232,128ZM116,80a12,12,0,1,1,12,12A12.0006,12.0006,0,0,1,116,80Zm0,48a12,12,0,1,1,12,12A12.0006,12.0006,0,0,1,116,128Zm0,48a12,12,0,1,1,12,12A12.0006,12.0006,0,0,1,116,176Z"/>`}
      ${weight === "light" &&
